package me.timvinci.terrastorage.client.gui;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.serialization.Codec;
import me.timvinci.terrastorage.config.client.ClientConfigManager;
import me.timvinci.terrastorage.config.client.TerrastorageClientConfig;
...
public class ButtonsCustomizationScreen extends Screen {
    private static final ResourceLocation TEXTURE = GenericContainerScreenAccessor.TEXTURE();
    ...
    public ButtonsCustomizationScreen(Screen lastScreen) {
    ...
    private void setWidthCustomizationEnabled(boolean enabled) {
        ...
        customizationWidgets.get(6).setTooltip(Tooltip.create(enabled ? Component.empty() : Component.translatable("terrastorage.option.tooltip.button_width_disabled")));
    }
    ...
    private void applyFromConfig(TerrastorageClientConfig config) {
        ...
        if (storageOptionsXOffset != config.getButtonsXOffset()) {
            storageOptionsXOffset = config.getButtonsXOffset();
            updateStorageOptionsX();
            if (customizationWidgets.get(4) instanceof AbstractOptionSliderButton optionSliderWidget) {
